...
// Russian
$lang['page_title'] = 'Запись оформлена с';
$lang['service_and_provider'] = 'Выберите услугу и мастера';
$lang['select_service'] = 'Выберите услугу';
$lang['select_provider'] = 'Выберите мастера';
$lang['duration'] = 'Длительность';
$lang['minutes'] = 'Минут';
$lang['price'] = 'Цена';
$lang['back'] = 'Назад';
$lang['appointment_date_and_time'] = 'Выбор даты и времени записи';
$lang['no_available_hours'] = 'Нет доступного времени в выбранную дату. Пожалуйста выберите другую дату.';
$lang['appointment_hour_missing'] = 'Пожалуйста выберите час записи и продолжите.';
...
$lang['cancel_appointment_hint'] = 'Нажмите кнопку "Отмена" для удаления записи из расписания компании.';
$lang['cancel'] = 'Отменить';
$lang['appointment_registered'] = 'Ваша запись благополучно зарегистрирована.';
$lang['cancel_appointment_title'] = 'Отмена записи';
$lang['appointment_cancelled'] = 'Ваше запись успешно отменена.';
$lang['appointment_cancelled_title'] = 'Запись отменена';
$lang['reason'] = 'Причина';
$lang['appointment_removed_from_schedule'] = 'Следующая запись была удалена из расписания компании.';
$lang['appointment_details_was_sent_to_you'] = 'Письмо с деталями 1 уже вам отправлено.';
$lang['add_to_google_calendar'] = 'Добавить в Google-календарь';
$lang['appointment_booked'] = 'Ваша запись успешно внесена в заказ.';
$lang['thank_you_for_appointment'] = 'Благодарим за запись. Ниже вы можете увидеть детали вашего визита. Внесите изменения, нажав на ссылку записи.';
$lang['appointment_details_title'] = 'Детали записи';
$lang['customer_details_title'] = 'Детали клиента';
$lang['service'] = 'Услуга';
$lang['provider'] = 'Мастер';
$lang['customer'] = 'Клиент';
$lang['start'] = 'Начало';
$lang['end'] = 'Окончание';
$lang['name'] = 'Имя';
$lang['appointment_link_title'] = 'Ссылка на запись';
$lang['success'] = 'Готово.';
$lang['appointment_added_to_google_calendar'] = 'Ваша запись была внесена в Google-календарь вашего аккаунта.';
$lang['view_appointment_in_google_calendar'] = 'Нажмите сюда для просмотра вашей записи в Google-календаре.';
$lang['appointment_added_to_your_plan'] = 'Новая запись была добавлена в ваш график.';
$lang['appointment_link_description'] = 'Вы можете внести изменения, кликнув на ссылку записи ниже.';
$lang['appointment_locked'] = 'Нельзя отредактировать.';
$lang['appointment_locked_message'] = 'The appointment cannot be changed less than {$limit} hours in advance.';
$lang['appointment_not_found'] = 'Запись не найдена.';
$lang['appointment_does_not_exist_in_db'] = 'Запись, которую вы запросили в базе данных, отсутствует.';
...
$lang['manage_appointment_record_hint'] = 'Управление записями, которые доступны мастерам и клиентам.';
$lang['select_filter_item_hint'] = 'Выберите мастера или услугу и просматривайте соответствующее записи в календаре.';
$lang['enable_appointment_sync_hint'] = 'Включить синхронизацию записей с Google-календарями мастеров.';
$lang['manage_customers_hint'] = 'Управление зарегистрированными клиентами и просмотр их истории записей.';
$lang['manage_services_hint'] = 'Управление доступными категориями и услугами компании.';
$lang['manage_users_hint'] = 'Управление пользователей компании (администраторами, мастерами, секретарями).';
$lang['settings_hint'] = 'Перейти к настройкам пользователя.';
$lang['log_out_hint'] = 'Выйти из кабинета.';
$lang['unavailable_periods_hint'] = 'На протяжении недоступного периода мастер не будет принимать новые записи.';
$lang['new_appointment_hint'] = 'Создать новую запись и сохранить ее в базе данных.';
$lang['reload_appointments_hint'] = 'Перезагрузить календарь записей.';
$lang['trigger_google_sync_hint'] = 'Инициировать процесс синхронизации Google-календаря.';
$lang['appointment_updated'] = 'Запись успешно обновлена.';
$lang['undo'] = 'Отменить';
$lang['appointment_details_changed'] = 'Детали записи изменены.';
$lang['appointment_changes_saved'] = 'Запись успешно изменена и сохранена.';
$lang['save'] = 'Сохранить';
$lang['new'] = 'Новый';
$lang['select'] = 'Выбрать';
$lang['hide'] = 'Скрыть';
...
$lang['new_appointment_title'] = 'Новая запись';
$lang['edit_appointment_title'] = 'Редактировать запись';
$lang['delete_appointment_title'] = 'Удалить запись';
$lang['write_appointment_removal_reason'] = 'Пожалуйста, не пожалейте минутки и напишите причину удаления записи:';
$lang['appointment_saved'] = 'Запись успешно сохранена.';
...
$lang['add_breaks_during_each_day'] = 'Добавить рабочий перерыв для каждого рабочего дня. Во время перерывов исполнитель не сможет принимать какие-либо записи.';
$lang['day'] = 'День';
$lang['days'] = 'Дни';
...
$lang['go_to_booking_page'] = 'Перейти на страницу записи';
...
$lang['you_need_to_login'] = 'Добро пожаловать! Вам необходимо войти для управлениям вашими записями.';
...
$lang['delete_provider'] = 'Удалить мастера';
...
$lang['no_privileges_edit_appointments'] = 'Вы не имеете необходимых привилегий для редактирования записи.';
...
$lang['select_google_calendar_prompt'] = 'Выберите календарь который вы хотите синхронизировать с вашими записими. Если вы не выберите будет использован ваш Google-календарь по умолчанию.';
...
$lang['any_provider'] = 'Любой мастер';
